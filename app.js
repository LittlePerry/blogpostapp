...
app.get("/posts/:postID", function(req, res) {
  ...
  posts.forEach(function(myPost) {
    if (_.lowerCase(myPost.title) ===_.lowerCase(req.params.postID)) {
      res.render("post", { titlePost: myPost.title,
                          contentPost: myPost.content});
    }
  })
});
